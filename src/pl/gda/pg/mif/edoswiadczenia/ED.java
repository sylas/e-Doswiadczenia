...
public class ED {
    ...
    public static String edLink;
    public static String edName;
    public static String edFileSWFName;
    public static String edInfo;
    public static String edInfoRun;
    public static String edSubDir;
